...
AEclipseCharacter::AEclipseCharacter()
{
	...
	// Gravity should be normal at start
	bIsGravityNormal = true;
...
void AEclipseCharacter::SetHasRifle(bool bNewHasRifle)
{
	bHasRifle = bNewHasRifle;
}

bool AEclipseCharacter::GetHasRifle()
{
	return bHasRifle;
}

void AEclipseCharacter::SwitchGravityDirection()
{
